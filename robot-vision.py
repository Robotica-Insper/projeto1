...
video_width, video_height = 600, 600
...
def img_callback(img):
	...
	try:
		...
		next_movement = camshift(cv_image)
		depois = time.clock()
...
def publish_movement(key_binding, pub):
...
# setup the mouse callback
	...
	while (True):
		publish_movement(next_movement, velocidade_saida)
